class Columns {
    ...
    flowColumns = () => {
        ...
        let offsetNeeded
        if (lastParagraphBottom + 42 > windowInnerHeight) {
            offsetNeeded = this.roundNearest(window.scrollY + this.offsetOriginal, this.secondParagraphLineHeight);
        } else {
            offsetNeeded = this.roundNearest(window.scrollY + lastParagraphBottom + 42 - windowInnerHeight, this.secondParagraphLineHeight);
        }
        const offsetDifference = offsetNeeded - this.offsetOld;
